...
function get_pythons_from_deadsnake {
...
function compile_python {
    ...
    wget https://www.python.org/ftp/python/${py_dir}/${ftgz}
    tar zxf ${ftgz}
...
function build_2_7_11_narrow {
    ...
    /opt/cp27m/bin/python -mensurepip
}

# Compilation of python 3.7+ needs SSL 1.0.2, not available for Trusty.
